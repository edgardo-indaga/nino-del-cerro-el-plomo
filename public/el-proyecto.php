    ...
    <div class="container mx-auto md:mt-[70px]">
        <div class="grid grid-cols-2">
            <div class="md:mx-[15px]">
                ...
                <div class="flex flex-col md:bg-[#c5ab98] md:pt-[90px] 2xl:pt-[110px] md:px-[40px] md:h-[550px] 2xl:h-[650px] md:cursor-pointer hidden" onmouseout="mostrarFrontMuseo()" id="museo">
            ...
            <div class="md:mx-[15px]">
                ...
                <div class="flex flex-col md:bg-[#c5ab98] md:pt-[80px] md:px-[40px] md:h-[550px] 2xl:h-[650px] md:cursor-pointer hidden" id="facultad" onmouseout="mostrarFrontFacultad()">
...
<section class="bg-[#53171A] md:bg-[#53171A] py-[80px] md:py-[100px] 2xl:py-[120px]">
    <div class="container mx-auto">
        <div class="flex flex-col justify-items-center align-middle items-center justify-center">
            <h4 class="text-center font-avenir text-[#d2bba6] font-bold md:shadow-[0, 0, 0, 0.16] md:text-[28px] md:leading-[36px] 2xl:text-[35px] 2xl:leading-[45px] pb-[80px] md:pb-[100px] 2xl:pb-[120px]">¿Qué acciones considera el proyecto <br>
