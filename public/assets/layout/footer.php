...
<button id="to-top-button" onclick="goToTop()" title="Go To Top"
        class="hidden fixed z-50 bottom-10 right-10 p-2 border-[2px] border-[#D2BBA6] w-11 h-11 rounded-full shadow-md bg-[#53171A] hover:bg-[#D2BBA6] hover:text-[#53171A] hover:border-[#53171A] text-[#D2BBA6] text-lg font-semibold transition-colors duration-300">
...
<script src="assets/js/open-siderbar.js"></script>
